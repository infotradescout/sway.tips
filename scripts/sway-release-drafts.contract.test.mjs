...
for (const term of [
  ...
  "BASE_REQUIRED_RIGHTS",
  'const proposedReadiness = buildReleaseReadiness({',
  'declarations: []',
  'credits, readiness: proposedReadiness',
...
for (const term of [
  ...
  'Complete metadata must not bypass rights readiness.',
  ...
  'Each declaration review must open its exact sealed evidence once.',

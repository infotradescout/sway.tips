...
for (const term of [
  'type ShareMetadata',
  'DEFAULT_SHARE_IMAGE_PATH = \'/social-preview.png?v=4\'',
...
for (const term of [
  'https://app.sway.tips/social-&#112;review.png?v=4',
  'twitter:image" content="https://app.sway.tips/social-&#112;review.png?v=4"'
]) {

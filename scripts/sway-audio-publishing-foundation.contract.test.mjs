...
const migration = read('drizzle/0019_audio_publishing_foundation.sql');
...
for (const term of [
  'This is a schema-and-contract slice.',
  ...
  'No private file or pairing route is live in this slice',

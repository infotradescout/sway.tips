...
for (const term of ['Payment volume and recaps', "typeof room.capturedAmount === 'number'", 'room.capturedEarnings', 'Test payment volume — no real money or payout', 'completedActions']) {

...
export const sourceSha='1a32aa4cfb5c7adde57a786c74174e677cf3eaa7';
export const downloadSourceSha='1a32aa4cfb5c7adde57a786c74174e677cf3eaa7';
...
if(process.env.GRINDZONE_PHONE_ENABLED==='true'){
  ...
  for(const mode of ['local','live'])for(const kind of ['phone','zones','discovery','cache','studio','save-data','locations']){

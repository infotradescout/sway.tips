...
export const sourceSha='796a0286f7eeba02fccfe77482578dddcd512255';
export const downloadSourceSha='796a0286f7eeba02fccfe77482578dddcd512255';
...
if(process.env.GRINDZONE_PHONE_ENABLED==='true'){
  ...
  for(const mode of ['local','live'])for(const kind of ['phone','zones','discovery','cache','studio','save-data','locations','herds']){

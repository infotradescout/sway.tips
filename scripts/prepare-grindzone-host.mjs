...
export const sourceSha='6b97f38a0acf536a0932dbb7d9df58233089cbb6';
export const downloadSourceSha='6b97f38a0acf536a0932dbb7d9df58233089cbb6';
...
if(process.env.GRINDZONE_PHONE_ENABLED==='true'){
  ...
  for(const mode of ['local','live'])for(const kind of ['phone','zones','discovery','cache','studio','save-data']){

...
export const sourceSha='bf8f18f8af1be9d334452ca74b2cee8682c97e15';
export const downloadSourceSha='bf8f18f8af1be9d334452ca74b2cee8682c97e15';
...
if(process.env.GRINDZONE_PHONE_ENABLED==='true'){
  ...
  for(const mode of ['local','live'])for(const kind of ['phone','zones','discovery','cache']){

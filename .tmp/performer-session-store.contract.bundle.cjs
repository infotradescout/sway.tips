...
var performer_session_store_exports = {};
__export(performer_session_store_exports, {
  PERFORMER_SESSION_COOKIE_NAME: () => PERFORMER_SESSION_COOKIE_NAME,
  createPerformerSessionStore: () => createPerformerSessionStore,
  hashPerformerSessionToken: () => hashPerformerSessionToken
});
module.exports = __toCommonJS(performer_session_store_exports);

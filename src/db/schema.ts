...
// Audio projects are resource-scoped collaboration spaces on the performer side.
// In the future storage slice, original file bytes will live in object storage; PostgreSQL
// will store immutable identity, integrity, access, rights, release, delivery, and transfer records only.
...
export const audioFileAccessGrants = pgTable('audio_file_access_grants', {
  ...
  permissionRequired: check('audio_file_access_grants_permission_required', sql`${table.canStreamPreview} = true or ${table.canDownloadOriginal} = true or ${table.canUploadNewVersion} = true`),

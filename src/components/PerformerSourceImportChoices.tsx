      ...
      <section data-sway-source-import-choices="true" className="sway-source-panel">
        ...
        <div className="sway-source-actions">
          ...
          <details data-sway-spotify-source-picker="true">
            ...
            <p className="sway-source-description">Add up to 1,000 songs from a playlist available to Sway. This adds songs to your request library, not a Spotify playback connection.</p>
          </details>

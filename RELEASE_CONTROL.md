...
- **Sway.DIO economics** (when that lane is built): zero-take, listener-directed streaming per `docs/SWAY_DIO_ECONOMIC_MODEL.md` — not a fixed per-stream rate and not a platform-wide streamshare pool.

...
CREATE TABLE "audio_candidate_owner_decisions" (
  ...
  CONSTRAINT "audio_candidate_owner_decisions_candidate_id_audio_candidate_revisions_id_fk" FOREIGN KEY ("candidate_id") REFERENCES "audio_candidate_revisions"("id"),
  CONSTRAINT "audio_candidate_owner_decisions_project_id_audio_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "audio_projects"("id"),
  CONSTRAINT "audio_candidate_owner_decisions_performer_id_performers_id_fk" FOREIGN KEY ("performer_id") REFERENCES "performers"("id"),
  CONSTRAINT "audio_candidate_owner_decisions_actor_user_id_users_id_fk" FOREIGN KEY ("actor_user_id") REFERENCES "users"("id"),
  CONSTRAINT "audio_candidate_owner_decisions_promoted_version_id_audio_project_asset_versions_id_fk" FOREIGN KEY ("promoted_version_id") REFERENCES "audio_project_asset_versions"("id") DEFERRABLE INITIALLY DEFERRED,
